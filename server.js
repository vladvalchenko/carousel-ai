...
ПРАВИЛА (нарушение = плохой результат):
- headline: 3-6 слов, КОНКРЕТНО — цифра, факт, глагол действия, провокация. НЕ "Всё что нужно знать", НЕ "Важная информация". Примеры хорошего: "Один раз настроил — работает само", "Вы теряете 3 часа в день вот почему", "5 фич о которых никто не говорит"
- subhead: 4-8 слов — уточнение или контраргумент к headline
- body: 1-2 предложения с КОНКРЕТИКОЙ — цифры, примеры, механика. НЕ общие слова типа "это поможет вам", "очень удобно", "важно понимать"
- Слайд 1: сильный крючок — вопрос или утверждение которое останавливает скролл
- Слайды 2-${slideCount-1}: каждый = одна конкретная мысль, факт или механика из текста
- Слайд ${slideCount}: что делать прямо сейчас — конкретное действие, не "попробуйте"
- Запрещено: вода, общие слова, повторы, эмодзи, кавычки в заголовках
